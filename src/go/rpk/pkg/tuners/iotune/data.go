	...
	return map[string]map[string]map[string]io{
		"aws": {
			...
			"m7gd.8xlarge": {
				...
				"default": {"", 2 * 269588, 2 * 1263357056, 2 * 134608, 2 * 604995968, false},
			},

			// 12x large was not measured
			"m7gd.12xlarge": {
				// advertised:      805008                      402504
				"default": {"", 3 * 269588, 3 * 1263357056, 3 * 134608, 3 * 604995968, false},
			},

			"m7gd.16xlarge": {
				// advertised:     1073344                      536672
				// measured         752697,                     539426,
				"default": {"", 4 * 269588, 4 * 1263357056, 4 * 134608, 4 * 604995968, false},
			},
		},
	}
}
